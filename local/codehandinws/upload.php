...
$usedspace = 0;
$privatefiles = $fs->get_area_files($context->id, 'mod_codehandin', 'private', false, 'id', false);
...
foreach ($files as $file) {
    ...
    $file_record->filearea  = 'mod_codehandin';
    ...
    if ($existingfile) {
        ...
        $oldFile = $fs->get_file($contextid, $component, $filearea, $itemid, $filepath, $filename);
